...
const Payers = () => {
    ...
    const handlePageChange = async (page: number) => {
        ...
        const res = await fetchData("/payements/payers", userState?.access_token, take, newSkip);
        setData(res);
    ...
    const handlePageSizeChange = (event: React.ChangeEvent<HTMLSelectElement>) => {
        ...
        newSkip = 0;
        fetchData("/payements/payers", userState?.access_token, newPageSize, newSkip).then((res) => {
            setData(res);
        });
    };
