            ...
            <div className="collapse-title flex gap-7 justify-between items-center ">
                <div className="flex gap-3 items-center">
                        ...
                        </h1>
                        {
                            voucherEntity?.senderType == "WIIQARE_MANAGER" ? (
                                <span className="text-xs text-sky font-light">
                                    Généré par {" "}<span className="text-xs text-sky font-semibold text-orange">
                                        Admin WIIQARE
                                    </span>
                                </span>
                            ) : <><br /></>
                    ...
                    <div>
                        ...
                        <span className="text-xs text-sky font-semibold text-orange">{" "}</span>
                    </div>
                </div>
                                                ...
                                                <div className="flex flex-col items-center gap-2">
                                                    ...
                                                    <h4 className="text-sm text-center">
                                                        ...
                                                        <span className="text-orange font-semibold">
                                                            {voucherEntity?.senderType == "WIIQARE_MANAGER" ? "Admin WIIQARE" : sender?.firstName ?? '' + ' ' + sender?.lastName ?? ''}
                                                        </span>{' '}
                                                        à{' '}
                                                        <span className="text-orange font-semibold ">
                                                            {patient?.firstName ?? '' + ' ' + patient?.lastName ?? ''}
