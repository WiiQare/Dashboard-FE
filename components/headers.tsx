...
function Header(props: Props) {
    return (
        <div>
            <header className="  h-fit sticky top-0 z-999 flex w-full bg-[#0d65d8]  ">
                {/* dark:drop-shadow-none */}
                <div className="flex flex-grow items-center pl-0 justify-between py-4 shadow-2 2xl:pl-0">
                        ...
                        <button className="z-99999 block rounded-sm border border-stroke bg-white p-1.5 shadow-sm lg:hidden">
                            ...
                            <span className="relative block h-5.5 w-5.5 cursor-pointer">
                                <span className="du-block absolute right-0 h-full w-full">
                                    <span className="relative top-0 left-0 my-1 block h-0.5 w-0 rounded-sm bg-black delay-[0] duration-200 ease-in-out !w-full delay-300 ${'!w-full delay-300': !sidebarToggle }"></span>
                                    <span className="relative top-0 left-0 my-1 block h-0.5 w-0 rounded-sm bg-black delay-150 duration-200 ease-in-out !w-full delay-400 ${'!w-full delay-400': !sidebarToggle }"></span>
                                    <span className="relative top-0 left-0 my-1 block h-0.5 w-0 rounded-sm bg-black delay-200 duration-200 ease-in-out !w-full delay-500 ${'!w-full delay-500': !sidebarToggle }"></span>
                                </span>
                                <span className="du-block absolute right-0 h-full w-full rotate-45">
                                    <span className="absolute left-2.5 top-0 block h-full w-0.5 rounded-sm bg-black delay-300 duration-200 ease-in-out !h-0 delay-[0] ${'!h-0 delay-[0]': !sidebarToggle }"></span>
                                    <span className="delay-400 absolute left-0 top-2.5 block h-0.5 w-full rounded-sm bg-black duration-200 ease-in-out !h-0 dealy-200 ${'!h-0 dealy-200': !sidebarToggle }"></span>
                                </span >
                            </span >
                        </button >
                        {/* < !--Hamburger Toggle BTN-- > */}
                    ...
                    <div className=" sm:block h-[36px] bg-white ">
                            ...
                            <div className="relative" x-data="{ dropdownOpen: false }">
                                ...
                                <a className="flex items-center gap-4" href="#">
                                    ...
                                    <span className="hidden text-right lg:block">
                                        <span className="block text-sm font-medium text-white">Edward Newgate</span>
                                ...
                                {/* <!--Dropdown Start-- > */}
                                {/* <div x-show="dropdownOpen" className="absolute right-0 mt-4 flex w-62.5 flex-col rounded-sm border border-stroke bg-white shadow-default">
